...
function Profile({ fixed }) {
  ...
  return (
    <>
      ...
      <div className='block rounded-lg shadow-lg bg-gray-100 text-center p-6 mb-2'>
      <div className="flex mb-2">
          <a href="#!" className="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm">Meeting Place</a>
        </div>
        <div className="flex mb-2">
          <a href="#!" className="font-medium text-dark-600 hover:text-purple-700 focus:text-dark-800 duration-300 transition ease-in-out text-sm">{profile?.address}</a>
        </div>
      </div>
      <div className='block rounded-lg shadow-lg bg-gray-100 text-center p-6 mb-2'>
      <div className="flex mb-2">
          <a href="#!" className="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm">Meeting Times</a>
        </div>
        <div className="flex mb-2">
          <a href="#!" className="font-medium text-dark-600 hover:text-purple-700 focus:text-dark-800 duration-300 transition ease-in-out text-sm">{profile?.meetingtime}</a>
        </div>
      </div>
      <div className='block rounded-lg shadow-lg bg-gray-100 text-center p-6 mb-2'>
        <div className="flex mb-2">
          <a href="#!" className="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm">Church Bio</a>
        </div>
        <div className="flex mb-2">
          <a href="#!" className="font-medium text-dark-600 hover:text-purple-700 focus:text-dark-800 duration-300 transition ease-in-out text-sm">{profile?.bio}</a>
        </div>
      </div>
